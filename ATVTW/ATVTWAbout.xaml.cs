...
{
    /// <summary>
    /// Interaction logic for ATVTWAbout.xaml
    /// </summary>
    public partial class ATVTWAbout : Window
    {
        public ATVTWAbout()
        {
            InitializeComponent();
        ...
        public ATVTWAbout(Window parent) : this() {
            Owner = parent;
        }
        ...
        public string TWLibraryVersion {
            get { return "TWLibrary Version: " + GetAssemblyVersion(@"TWLibrary.dll"); }
        }

        /*public string AvalonEditVersion {
            get { return "AvalonEdit Version: " + GetAssemblyVersion(@"ICSharpCode.AvalonEdit.dll"); }
        }
        */
